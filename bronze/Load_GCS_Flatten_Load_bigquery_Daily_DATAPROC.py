...
def Load_BigQuery():
    ...
    spark = SparkSession.builder.master('local[*]').appName('historical data').config("spark.jars.packages", "com.google.cloud.spark:spark-bigquery-with-dependencies_2.12:0.34.0").getOrCreate()
